...
|     Команда     |                                            Значение команды                                             | 
|:---------------:|:-------------------------------------------------------------------------------------------------------:|
|    git stash    |                   Временное хранилище для неотслеживаемых и незакоммиченных изменений                   |
|   git reflog    |                       Список всех изменений в проекте, включая удаленные коммиты                        |
|    git merge    | Соединяет коммиты разных веток, путем создания merge-коммита, либо перемещением указателя(Fast-Forward) |
|   git rebase    |                         Изменяет родительский коммит для коммитов другой ветки                          |
| git cherry-pick |           Копирует коммит, включая изменения сделанные в нем, как укаазатель на другую ветку            |
